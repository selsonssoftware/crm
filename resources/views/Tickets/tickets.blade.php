                        ...
                        <div class="card">
                            <div class="card-header d-flex align-items-center justify-content-between flex-wrap row-gap-3">
                                ...
                                <div class="d-flex align-items-center">
                                    <span class="badge badge-danger d-inline-flex align-items-center"><i class="ti ti-circle-filled fs-5 me-1"></i>{{$data->priority}}</span>
                            ...
                            <div class="card-body">
                                <div>
                                    ...
                                    <div class="d-flex align-items-center mb-2">
                                        <h5 class="fw-semibold me-2"><a href="{{ route('ticket.details', $data->ticket_id) }}">{{$data->event_category}}</a></h5>
                                        <span class="badge bg-outline-pink d-flex align-items-center ms-1"><i class="ti ti-circle-filled fs-5 me-1"></i>{{$data->status}}</span>
                                    </div>
                                    <div class="d-flex align-items-center flex-wrap row-gap-2">
                                        <p class="d-flex align-items-center mb-0 me-2">
                                            <img class="border border-white" src="{{ asset('uploads/logo/' . $data->logo) }}"
										style="width:50px;height:50px;border-radius:50%"></th> Assigned to <span class="text-dark ms-1">{{$data->first_name}} {{$data->last_name}}</span>
                                        </p>
                                        <p class="d-flex align-items-center mb-0 me-2"><i class="ti ti-calendar-bolt me-1"></i>Updated {{$data->updated_at}}</p>
                                ...
                                <div class="d-flex flex-column">
                                    <div class="d-flex align-items-center justify-content-between border-bottom p-3">
                                        <span class="d-flex align-items-center">
											<img src="https://smarthr.co.in/demo/html/template/assets/img/profiles/avatar-01.jpg" class="avatar avatar-xs rounded-circle me-2" alt="img">Edgar Hansel
										</span>
                                        <div class="d-flex align-items-center">
                                            <span class="badge badge-xs bg-dark rounded-circle">0</span>
                                        </div>
                                    ...
                                    <div class="d-flex align-items-center justify-content-between border-bottom p-3">
                                        <span class="d-flex align-items-center">
											<img src="https://smarthr.co.in/demo/html/template/assets/img/profiles/avatar-02.jpg" class="avatar avatar-xs rounded-circle me-2" alt="img">Ann Lynch
										</span>
                                        <div class="d-flex align-items-center">
                                            <span class="badge badge-xs bg-dark rounded-circle">1</span>
                                        </div>
                                    ...
                                    <div class="d-flex align-items-center justify-content-between border-bottom p-3">
                                        <span class="d-flex align-items-center">
											<img src="https://smarthr.co.in/demo/html/template/assets/img/profiles/avatar-03.jpg" class="avatar avatar-xs rounded-circle me-2" alt="img">Juan Hermann
										</span>
                                        <div class="d-flex align-items-center">
                                            <span class="badge badge-xs bg-dark rounded-circle">0</span>
                                        </div>
                                    ...
                                    <div class="d-flex align-items-center justify-content-between p-3">
                                        <span class="d-flex align-items-center">
											<img src="https://smarthr.co.in/demo/html/template/assets/img/profiles/avatar-04.jpg" class="avatar avatar-xs rounded-circle me-2" alt="img">Jessie Otero
										</span>
                                        <div class="d-flex align-items-center">
                                            <span class="badge badge-xs bg-dark rounded-circle">2</span>
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" placeholder="Add Question" name="ticket_description"></textarea>
                                    </div>
                                    <div class="mb-3">
