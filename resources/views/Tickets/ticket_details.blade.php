...
<div class="page-wrapper">
	 <div class="content">
                ...
                <!-- <div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb mb-3">
                    <div class="mb-2">
                        <h6 class="fw-medium d-flex align-items-center"><a href="https://smarthr.co.in/demo/html/template/tickets.html"><i class="ti ti-arrow-left me-2"></i>Ticket Details</a></h6>
                    </div>
                   ...
                   <div class="col-xl-9 col-md-8">
                        <div class="card">
                            <div class="card-header d-flex align-items-center justify-content-between flex-wrap row-gap-3">
                                <h5 class="text-info fw-medium">{{$ticket->title}}</h5>
                                <div class="d-flex align-items-center">
                                    <span class="badge bg-danger me-3"><i class="ti ti-circle-filled fs-5 me-1"></i> {{ $ticket->priority }}</span>
                                    <div class="dropdown">
                            ...
                            <div class="card-body">
                                <div>
                                        ...
                                        <div class="d-flex align-items-center flex-wrap">
                                            <div class="mb-3">
                                                ...
                                                <div class="d-flex align-items-center mb-2">
                                                    <h5 class="fw-semibold me-2">{{$ticket->event_category}}</h5>
                                                    <span class="badge bg-outline-pink d-flex align-items-center ms-1"><i class="ti ti-circle-filled fs-5 me-1"></i> {{$ticket->status}}</span>
                                                </div>
                                                <div class="d-flex align-items-center flex-wrap row-gap-2">
                                                    <p class="d-flex align-items-center mb-0 me-2">
                                                         <img class="border border-white" src="{{ asset('uploads/logo/' . $ticket->logo) }}"
										style="width:50px;height:50px;border-radius:50%"> Assigned to <span class="text-dark ms-1">{{$ticket->first_name}} {{$ticket->last_name}}</span>
                                                    </p>
                                                    <p class="d-flex align-items-center mb-0 me-2"><i class="ti ti-calendar-bolt me-1"></i>Updated {{$ticket->updated_at}}</p>
                                    ...
                                    <div class="border-bottom mb-3 pb-3">
                                        <div>
                                            <p class="mb-3"> {{$ticket->ticket_description}}</p>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body p-0">
                                <div class="border-bottom p-3">
                                    <form action="{{ route('ticket.update', $ticket->ticket_id) }}" method="POST">
                @csrf
                ...
                <div class="mb-3">
                    ...
                    <select class="select form-control" name="assign_to">
                        <option value="">Select</option>

                        @foreach($employees as $emp)
                            <option value="{{ $emp->employee_id }}"
                                {{ $ticket->assign_to == $emp->employee_id ? 'selected' : '' }}>
                ...
                <div class="mb-3">
                    ...
                    <select class="select form-control" name="status">
                        <option value="Open" class="bg-success" {{ $ticket->status == 'Open' ? 'selected' : '' }}>Open</option>
                        <option value="On Process" class="bg-info" {{ $ticket->status == 'On Process' ? 'selected' : '' }}>On Process</option>
                        <option value="Close" class="bg-" {{ $ticket->status == 'Close' ? 'selected' : '' }}>Close</option>
                    </select>
                </div>
                ...
                <!-- <div class="modal fade" id="edit_ticket">
                    <div class="modal-dialog modal-dialog-centered modal-lg">
                        <div class="modal-content">
                            ...
                            <form action="https://smarthr.co.in/demo/html/template/tickets-grid.html">
