				...
				<div class="d-flex my-xl-auto right-content align-items-center flex-wrap row-gap-3">
					<div class="dropdown me-3">
						...
						<ul class="dropdown-menu dropdown-menu-end p-3">
							<li>
								<a href="{{ url('/employee_list') }}" class="dropdown-item rounded-1">
									All
								</a>
							</li>
									...
									<td>
										<div class="action-icon d-inline-flex">
											...
											<a href="#" class="me-2" data-bs-toggle="modal"
												data-bs-target="#edit_user-{{$data->employee_id}}"><i
													class="ti ti-edit"></i></a>
											<a href="#" data-bs-toggle="modal"
												data-bs-target="#delete_modal{{$data->employee_id}}"><i
														...
														<div class="col-md-6">
															<div class="mb-3">
																...
																<input type="text" class="form-control"
																	value="{{$data->first_name}}" name="last_name">
															</div>
														</div>
														<div class="col-md-6">
															<div class="mb-3">
																...
																<input type="text" class="form-control"
																	value="{{$data->last_name}}" name="first_name">
															</div>
														</div>
														<div class="col-md-6">
															<div class="mb-3">
														...
														<div class="col-md-6">
															<div class="mb-3">
																...
																<select class="select" name="status">
																	...
																	<option value="Inactive" {{ $data->status == 'Inactive' ?
														...
														<div class="col-md-6">
															<div class="mb-3">
																...
																<select name="department_id" class="select"
																	...
																	<option value="{{ $dept->department_id }}" {{ $dept->
																		department_id == $data->department_id ? 'selected' : ''
																		}}>
																		{{ $dept->name }}
																	</option>
																	@endforeach
														...
														<div class="col-md-6">
															...
															<div class="position-relative d-inline-block">
																...
																<span class="remove-image-btn"
																	id="removeImageBtn-{{$data->employee_id}}" style="{{ $data->logo ? '' : 'display:none;' }};
															...
															<input type="file" class="form-control mt-2" name="logo"
																id="logoInput-{{$data->employee_id}}" accept="image/*">

															<!-- Hidden field for remove -->
															<input type="hidden" name="remove_logo"
																id="removeLogoField-{{$data->employee_id}}" value="0">
														</div>
													</div>
												</div>
										...
										<div class="modal-content">
											<div class="modal-body text-center">
												...
												<div class="d-flex justify-content-center">
													...
													<a href="/delete_employee?employee_id={{$data->employee_id}}"
						...
						<div class="modal-body pb-0">
							<div class="row">
								...
								<div class="col-md-12">
									...
									<div class="position-relative d-inline-block">
										<!-- Preview Box -->
										<img id="previewImage" src="/default-avatar.png" class="border rounded"
											style="width: 120px; height: 120px; object-fit: cover;">

										<!-- Remove Icon -->
										<span id="removeImageBtn" class="remove-image-btn" style="display: none;">
											&times;
										</span>
									</div>

									<!-- File Input -->
									<input type="file" class="form-control mt-2" name="logo" id="logoInput"
										accept="image/*">
								</div>
