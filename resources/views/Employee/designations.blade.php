  ...
  <td>{{ $item->department_name ?? 'No Department' }}</td>
    ...
    <td>
        <div class="action-icon d-inline-flex">
            <a href="#" data-bs-toggle="modal" data-bs-target="#edit_designation-{{$item->designation_id}}">
                <i class="ti ti-edit"></i>
            </a>
            <a href="#" data-bs-toggle="modal" data-bs-target="#delete_modal{{$item->designation_id}}">
                                ...
                                <div class="modal fade" id="edit_designation-{{$item->designation_id}}">
                                    <div class="modal-dialog modal-dialog-centered modal-md">
                                        <div class="modal-content">
											...
											@csrf
										      <input type="hidden" id="designation_id" name="designation_id" value="{{$item->designation_id}}">
    ...
    @foreach($departments as $dept)
        <option value="{{ $dept->department_id }}" 
            {{ (isset($item) && $item->department_id == $dept->department_id) ? 'selected' : '' }}>
            {{ $dept->name }}
        </option>
    @endforeach
</select>
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="mb-3">
                                                                ...
                                                                <select class="select" name="status" value="{{$item->status}}">
                                            ...
                                            <div class="modal-content">
                                                <div class="modal-body text-center">
                                                    ...
                                                    <div class="d-flex justify-content-center">
                                                        ...
                                                        <a href="/delete_designations?designation_id={{$item->designation_id}}"  class="btn btn-danger">Yes, Delete</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
