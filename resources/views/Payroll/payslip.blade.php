...
<div class="page-wrapper">
    ...
    <div class="mb-2">
        <button class="downloadPayslip btn btn-dark d-flex align-items-center">
            <i class="ti ti-download me-2"></i>Download PDF
        </button>
    </div>

    <div class="head-icons ms-2">
        <a href="javascript:void(0);" class="" payslip-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Collapse" id="collapse-header">
                                ...
                                <div class="card-body">
                                    <div class="row justify-content-between align-items-center border-bottom mb-3">
                                        <div class="col-md-6">
											<div class="mb-3">
												<div class="mb-2">
													<img src="../uploads/wbsl_logo.png" class="img-fluid" alt="logo" style="width:200px;height:110px">
												</div>
                                        ...
                                        <div class="col-md-6">
                                            <div class=" text-end mb-3">
                                                <h5 class="text-gray mb-1">Payslip No : <span class="text-primary">{{$payslip->payslip_number}}</span></h5>
                                                <p class="fw-medium">Salary Month : <span class="text-dark">{{$payslip->created_at}}</span> </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row border-bottom align-items-center mb-3">
                                        <div class="col-md-5">
											<div class="mb-3">
												...
												<div>
													...
													<p class="mb-1">Email : <span class="text-dark"><a href="https://smarthr.co.in/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="bac2c3c0cedfd9d2fadfc2dbd7cad6df94d9d5d7">[email&#160;protected]</a></span></p>
                                        ...
                                        <div class="col-md-5">
											<div class="mb-3">
												...
												<div>
													<h4 class="mb-1">{{$payslip->first_name}} {{$payslip->last_name}}</h4>
													<p class="mb-1">{{$payslip->title}}</p>
													<p class="mb-1">Email : {{$payslip->email}}<span class="text-dark"></span></p>
													<p>Phone : <span class="text-dark">+91 {{$payslip->phone}}</span></p>
												</div>
											</div>
                                        </div>
                                    </div>
									<div>
										<h5 class="text-center mb-4">Payslip for this moth {{$payslip->created_at}}</h5>
										<div class="row">
											<div class="col-md-6">
												<div class="list-group mb-3">
													...
													<div class="list-group-item">
														<div class="d-flex align-items-center justify-content-between">
															...
															<h6 class="fw-medium">{{$payslip->basic_salary}}</h6>
														</div>
													</div>
													<div class="list-group-item">
														<div class="d-flex align-items-center justify-content-between">
															<p class="mb-0">House Rent Allowance (H.R.A.)</p>
															<h6 class="fw-medium">{{$payslip->hra}}</h6>
														</div>
													</div>
													<div class="list-group-item">
														<div class="d-flex align-items-center justify-content-between">
															<p class="mb-0">Conveyance</p>
															<h6 class="fw-medium">{{$payslip->conveyance}}</h6>
														</div>
													</div>
													<div class="list-group-item">
														<div class="d-flex align-items-center justify-content-between">
															<p class="mb-0">Other Allowance</p>
															<h6 class="fw-medium">{{$payslip->allowance}}</h6>
														</div>
													</div>
													<div class="list-group-item">
														<div class="d-flex align-items-center justify-content-between">
															<p class="mb-0">Total Earnings</p>
															<h6 class="fw-medium">RS. {{ $totalEarnings }}</h6>
														</div>
													</div>
												</div>
											</div>
												...
												<div class="list-group mb-3">
													...
													<div class="list-group-item">
														<div class="d-flex align-items-center justify-content-between">
															...
															<h6 class="fw-medium">{{$payslip->tds}}</h6>
														</div>
													</div>
													<div class="list-group-item">
														<div class="d-flex align-items-center justify-content-between">
															<p class="mb-0">Provident Fund</p>
															<h6 class="fw-medium">{{$payslip->pf}}</h6>
														</div>
													</div>
													<div class="list-group-item">
														<div class="d-flex align-items-center justify-content-between">
															<p class="mb-0">ESI</p>
															<h6 class="fw-medium">{{$payslip->esi}}</h6>
														</div>
													</div>
													<div class="list-group-item">
														<div class="d-flex align-items-center justify-content-between">
															<p class="mb-0">DA</p>
															<h6 class="fw-medium">{{$payslip->da}}</h6>
														</div>
													</div>
													<div class="list-group-item">
														<div class="d-flex align-items-center justify-content-between">
															<p class="mb-0">Total Earnings</p>
															<h6 class="fw-medium">RS. {{ $totalDeductions }}</h6>
														</div>
													</div>
												</div>
											</div>
										...
										<div>
											<p>Net Salary : <span class="text-gray-9 fw-medium">  RS. {{ $netSalary }}</span></p>
										</div>
									</div>
            ...
            <div class="footer d-sm-flex align-items-center justify-content-between border-top bg-white p-3">
				...
				<p>Designed &amp; Developed By <a href="javascript:void(0);" class="text-primary">Selsons</a></p>
			</div>
...
document.addEventListener("DOMContentLoaded", function () {
    document.querySelectorAll(".downloadPayslip").forEach(function(button) {
        button.addEventListener("click", function () {
            var element = document.getElementById("payslipContent"); // container to export
            if (!element) {
            ...
            var opt = {
                margin: 0.5,
                filename: '{{ $payslip->payslip_number ?? "Payslip" }}.pdf',
