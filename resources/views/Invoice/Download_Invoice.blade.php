...
<div class="page-wrapper">
    ...
    <div class="mb-2">
        <a href="javascript:void(0);" id="downloadInvoice" class="btn btn-dark d-flex align-items-center">
                ...
                <div>
                    ...
                    <div class="row"  id="invoice-content">
                        <div class="col-sm-10 mx-auto">
							 <a href="/view_invoice" class="back-icon d-flex align-items-center fs-12 fw-medium mb-3 d-inline-flex">
                                    ...
                                    <div class="row justify-content-between align-items-center border-bottom mb-3">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class=" text-end mb-3">
                                                <h5 class="text-gray mb-1">Invoice No <span class="text-primary">{{$data->invoice_number}}</span></h5>
                                                <p class="mb-1 fw-medium">Created Date : <span class="text-dark">{{$data->created_at}}</span> </p>
                                                <p class="fw-medium">Due Date : <span class="text-dark">{{$data->due_date}}</span> </p>
                                            </div>
                                    ...
                                    <div class="row border-bottom mb-3">
                                        ...
                                        <div class="col-md-5">
                                            ...
                                            <div>
                                                ...
                                                <p class="mb-1">
                                                    Email : <span class="text-dark">{{ $data->email }}</span>
                                                </p>

                                                <p>
                                                    Phone : <span class="text-dark">{{ $data->phone }}</span>
                                                </p>
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            ...
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-gray-9 fw-medium text-end">RS. {{$item->rate}}</td>
                                                        <td class="text-gray-9 fw-medium text-end">RS. {{ $item->quantity * $item->rate }}</td>
                                                    </tr>
                                                    @endforeach
                                                </tbody>
                                            </table>
                                    ...
                                    <div class="row border-bottom mb-3">
                                        ...
                                        <div class="col-md-5">
                                            <div class="d-flex justify-content-between align-items-center border-bottom mb-2 pe-3">
                                                ...
                                                <p class="text-dark fw-medium mb-2">RS. {{$data->amount}}</p>
                                            </div>
                                            <div class="d-flex justify-content-between align-items-center border-bottom mb-2 pe-3">
                                                <p class="mb-0">Discount(0%)</p>
                                                <p class="text-dark fw-medium mb-2"> {{$data->discount}}</p>
                                            </div>
                                            <div class="d-flex justify-content-between align-items-center mb-2 pe-3">
                                                <p class="mb-0">TAX(0%)</p>
                                                <p class="text-dark fw-medium mb-2"> {{$data->tax}}</p>
                                            </div>
                                            <div class="d-flex justify-content-between align-items-center mb-2 pe-3">
                                                <h5>Total Amount</h5>
                                                <h5>RS.  {{$data->total}}</h5>
...
<!-- html2pdf JS -->
<!-- Include html2pdf.js BEFORE your custom script -->
