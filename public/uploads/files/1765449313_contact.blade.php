...
@section('content')
                                        ...
                                        <div class="col-sm-6">
                                            <div class="wrapper phone">
                                                ...
                                                <div class="wrapper-content">
                                                    ...
                                                    <p class="paragraph">{{ $settings['contact_phone'] ?? '' }}</p>
                                                </div>
                                            </div>
                                        </div>
  ...
  <!-- Location pin -->
  <path d="M22 30C22 30 14 22.5 14 17.5C14 13.9101 16.9101 11 20.5 11C24.0899 11 27 13.9101 27 17.5C27 22.5 22 30 22 30Z" 
        fill="#34a853" stroke="#34a853"/>

  <!-- Inner circle of pin -->
  <circle cx="20.5" cy="17.5" r="2.5" fill="white" stroke="#34a853"/>
</svg>
                                                ...
                                                <div class="wrapper-content">
                                                    ...
                                                    <p class="paragraph">{{ $settings['site_address'] ?? '' }}</p>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="wrapper phone">
                                                ...
                                                <div class="wrapper-content">
                                                    ...
                                                    <p class="paragraph">{{ $settings['contact_email'] ?? '' }}</p>
                                                </div>
                                            </div>
                                        </div>
										...
										<div class="col-sm-12">
											 <h5 class="wrapper-heading">Social Media Links</h5><br>
											<br>
											
											<div class="social-items d-flex flex-row gap-3">
    @foreach ($data as $link)
        <!-- Icon left (clickable) -->
         <a href="{{ $link->url }}" target="_blank" class="social-icon" style="text-decoration: none;">
            <i class="{{ $link->icon }}" style="font-size: 32px; color: green;"></i>
        </a>
    @endforeach
</div>
                                            ...
                                            <div class="address">
                                                <div class="contact-address">
                                                    ...
                                                    <div class="address-content">
                                                        <h5 class="wrapper-heading">Address</h5>
                                                        <p class="paragraph">LIG-B/498,DR A.S. RaoNagar KAPRA, ECIL,HYDERABAD-500062</p>
                                                    </div>
                                                </div>
                                                <div class="contact-map">
                                                    <iframe
                                                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2770.007428393387!2d78.555902173412!3d17.47582910025481!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bcb9b83b32063a9%3A0xab27e9472c9a1020!2sLigB%2C%20East%20Maruthi%20Nagar%2C%20A.%20S.%20Rao%20Nagar%2C%20Secunderabad%2C%20Telangana%20500062!5e1!3m2!1sen!2sin!4v1764578249785!5m2!1sen!2sin"
                    ...
                    <div class="col-lg-6">
                        <div class="question-section login-section ">
						 ...
						 {{-- Session Success/Error Message --}}
                            ...
                            @endif
                             <form action="/storingcontact" method="post" class="contact-form">
                                    @csrf
                                    <div class="review-form-text">
                                        <h5 class="comment-title">Get In Touch</h5>
                                        <img src="website-assets/images/homepage-one/vector-line.png" alt="img">
                                    </div>
                                    <div class=" account-inner-form">
                                        <div class="review-form-name">
                                            <label for="fname" class="form-label">Name*</label>
                                            <input type="text" id="fname" class="form-control" placeholder="Name" name="name">
                                        </div>
                                        <div class="review-form-name">
                                            <label for="email" class="form-label">Email*</label>
                                            <input type="email" id="email" class="form-control"
                                                placeholder="user@gmail.com" name="email">
                                        </div>
                                        <div class="review-form-name">
                                    ...
                                    <div class="review-textarea">
                                        ...
                                        <textarea class="form-control" placeholder="Write Massage..........."
                                            id="floatingTextarea" rows="3" name="message"></textarea>
                                    </div>
                                    <div class="login-btn">
